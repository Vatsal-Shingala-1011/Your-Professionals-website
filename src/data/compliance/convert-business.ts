...
export const CONVERT_BUSINESS: Record<string, ServiceData> = {
    ...
    'convert-partnership-into-llp': {
        ...
        subtitle: 'Converting a traditional partnership to aLimited Liability Partnership (LLP)offers several key advantages. The most significant is limited liability, which protects your personal assets from business',
        heroFeatures: [
            'Converting a traditional partnership to aLimited Liability Partnership (LLP)offers several key advantages.',
        ...
        overview: {
            ...
            highlights: [
                { icon: '📋', text: 'Converting a traditional partnership to aLimited Liability Partnership (LLP)offers several key advantages.' },
        ...
        eligibility: [
            ...
            'Absence of Security Interest on Assets:There should be no existing security interests (such as mortgages or charges) on the partnership firms assets at the time of submitting the conversion application.',
